...
public class SceneBuilder {
    ...
    public static void startSearchUserFrom() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(ControladorApplication.class.getResource("user-search-form.fxml"));
            Stage vehicleStage = new Stage();
            vehicleStage.setScene(new Scene(fxmlLoader.load()));
            vehicleStage.setTitle("Usuário"); // TODO: Get title from a properties file
            vehicleStage.show();
        } catch (Exception e) {
            // TODO: Make following messages parametrizable by a properties file
            Alert errorAlert = new Alert(Alert.AlertType.ERROR, "Houve um erro ao abrir a janela de pesquisa de viagens.");
    ...
    public static void startSearchManagerFrom() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(ControladorApplication.class.getResource("manager-search-form.fxml"));
            Stage vehicleStage = new Stage();
            vehicleStage.setScene(new Scene(fxmlLoader.load()));
            vehicleStage.setTitle("Gerente"); // TODO: Get title from a properties file
            vehicleStage.show();
        } catch (Exception e) {
            // TODO: Make following messages parametrizable by a properties file
            Alert errorAlert = new Alert(Alert.AlertType.ERROR, "Houve um erro ao abrir a janela de pesquisa de gerentes.");
            errorAlert.setHeaderText("Erro!");
            errorAlert.setTitle("Erro interno");
            errorAlert.showAndWait();
            e.printStackTrace(); // TODO: Change for SLF4J implementation
